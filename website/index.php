...
<div class="column prepend-1 span-24 first last">
  <h2>Welcome to NDHUISC</h2>
  <p>
    On NDHUISC, you can share all your crazy pics with your friends. <br />
    But that's not all, you can also buy the rights to the high quality <br />
    version of someone's pictures. NDHUISC is fun for the whole family.
  </p>
  ...
  <p>
    <h4>Or you can test to see if NDHUISC can handle a file:</h4> <br />
  <script>
